...
class Car(models.Model):
    ...
    registeration_number = models.CharField(max_length=10, null = True, blank=True)
...
class car_rating(models.Model):
    registeration_number = models.CharField(max_length=10)
    rating               = models.IntegerField(default=0)
    Comments             = models.CharField(max_length=10, default=0)
    def __str__(self):
